...
export function SummaryCards({
  ...
  const metrics = useMemo(() => [
    ...
    {
      title: 'Blended CPA (FTD)',
      value: blendedCpa ? formatCurrency(blendedCpa) : 'N/A',
      subtitle: blendedCpa ? `Per acquired FTD` : 'No conversions',
    ...
    },
    {
      ...
      subtitle: `${formatNumber(totalConversions)} FTDs acquired`,
      trend: 'up' as const,
      icon: <Users className="h-5 w-5 text-success" />,
      accentColor: 'hsl(var(--success))',
    },
    {
      title: 'Est. Net Revenue (NGR)',
      value: formatCurrency(projectedRevenue, true),
      subtitle: `${blendedRoas.toFixed(2)}x ROAS (after 59% deductions)`,
