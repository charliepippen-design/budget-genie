...
const IGAMING_CHANNELS: T[] = [
  { key: 'affiliate-cpa', name: 'Affiliates - CPA', category: 'Affiliate', family: 'affiliate', buyingModel: 'CPA', price: 200, ctr: 4, clickToLead: 8, leadToConversion: 25, ltv: 250, saturationCeiling: 80000, bannedIn: ['IT'], fit: fit(1, 0.1, 0.2), baseWeight: 1.4, tags: ['proven'], note: 'Pay only per FTD; backbone of most casino/sportsbook plans.' },
  { key: 'affiliate-hybrid', name: 'Affiliates - Hybrid (CPA + RevShare)', category: 'Affiliate', family: 'affiliate', buyingModel: 'HYBRID', price: 100, secondaryPrice: 25, ctr: 4, clickToLead: 8, leadToConversion: 25, ltv: 250, saturationCeiling: 50000, bannedIn: ['IT'], fit: fit(0.9, 0.2, 0.2), baseWeight: 0.8, tags: ['proven'], note: 'Lower upfront CPA, long-tail revshare cost.' },
  { key: 'affiliate-listing', name: 'Affiliates - Listing Fees (Fixed)', category: 'Affiliate', family: 'affiliate', buyingModel: 'FLAT_FEE', price: 1000, ctr: 3.5, clickToLead: 12, leadToConversion: 20, ltv: 220, trafficPerUnit: 800, saturationCeiling: 4000, bannedIn: ['IT'], fit: fit(0.7, 0, 0.5), baseWeight: 0.5, minBudget: 10000, tags: ['fixed_cost'], note: 'Top-3 positions on comparison sites.' },
  { key: 'google-search', name: 'Google Search (Licensed)', category: 'Paid Search', family: 'paid_media', buyingModel: 'CPC', price: 6, ctr: 4, clickToLead: 10, leadToConversion: 25, ltv: 280, saturationCeiling: 40000, bannedIn: ['IT'], fit: fit(1, 0.2, 0.3), baseWeight: 1, minBudget: 15000, tags: ['restricted', 'proven'], note: 'Needs Google gambling certification in each market.' },
  { key: 'meta-social', name: 'Meta Ads (Licensed)', category: 'Paid Social', family: 'paid_media', buyingModel: 'CPM', price: 9, ctr: 0.9, clickToLead: 4, leadToConversion: 18, ltv: 200, saturationCeiling: 30000, bannedIn: ['IT'], fit: fit(0.7, 0.3, 0.7), baseWeight: 0.7, tags: ['restricted'], note: 'Only with written Meta approval for gambling.' },
  { key: 'native', name: 'Native Ads', category: 'Display/Programmatic', family: 'paid_media', buyingModel: 'CPM', price: 3.8, ctr: 0.45, clickToLead: 3, leadToConversion: 10, ltv: 160, saturationCeiling: 15000, bannedIn: ['IT'], fit: fit(0.7, 0, 0.3), baseWeight: 0.6, note: 'Scalable but lower player quality.' },
  { key: 'push', name: 'Push Notifications', category: 'Display/Programmatic', family: 'paid_media', buyingModel: 'CPM', price: 1.5, ctr: 1.2, clickToLead: 2.5, leadToConversion: 6, ltv: 90, saturationCeiling: 6000, bannedIn: ['IT'], fit: fit(0.5, 0, 0.1), baseWeight: 0.3, tags: ['experimental'], note: 'Cheap volume, low LTV; keep as a test budget.' },
  { key: 'programmatic', name: 'Programmatic Display', category: 'Display/Programmatic', family: 'paid_media', buyingModel: 'CPM', price: 5.5, ctr: 0.25, clickToLead: 4, leadToConversion: 10, ltv: 180, saturationCeiling: 25000, bannedIn: ['IT'], fit: fit(0.3, 0.1, 0.9), baseWeight: 0.5, note: 'Reach and brand recall more than direct FTDs.' },
  { key: 'retargeting', name: 'Retargeting (Pixel)', category: 'Display/Programmatic', family: 'paid_media', buyingModel: 'CPM', price: 7.5, ctr: 1.5, clickToLead: 8, leadToConversion: 20, ltv: 220, saturationCeiling: 4000, bannedIn: ['IT'], fit: fit(0.6, 0.8, 0.2), baseWeight: 0.4, tags: ['proven'], note: 'Small but very efficient; limited by site traffic.' },
  ...
  { key: 'sponsorship', name: 'Sports Sponsorship', category: 'Offline/TV', family: 'pr_brand', buyingModel: 'FLAT_FEE', price: 10000, ctr: 1, clickToLead: 3, leadToConversion: 15, ltv: 250, trafficPerUnit: 5000, saturationCeiling: 50000, bannedIn: ['IT'], fit: fit(0.2, 0.1, 1), baseWeight: 0.6, minBudget: 60000, tags: ['fixed_cost'], note: 'Brand play; weak short-term attribution.' },
];
...
export const INDUSTRY_PACKS: IndustryPack[] = [
  {
    ...
    complianceNotes: ['Google/Meta gambling ads need certification per market.', 'Responsible-gambling messaging required in most EU markets.', 'Italy (Decreto Dignità) bans gambling advertising: only SEO/content and CRM to existing customers are planned there.'],
