...
const VERTICAL_CONFIGS: Record<Vertical, VerticalConfig> = {
  igaming: {
    ...
    terms: {
      ...
      revenueMetric: 'Projected Player Value',
      returnMetric: 'ROAS',
...
You are powered by Claude claude-sonnet-4-6 for analysis and Gemini Flash for real-time responses.`,
    ...
    report: {
      ...
      revenueLabel: 'Projected Player Value (lifetime)',
...
You are powered by Claude claude-sonnet-4-6 for analysis and Gemini Flash for real-time responses.`,
  ...
  saas: {
    ...
    terms: {
      ...
      revenueMetric: 'Projected Customer Value',
...
You are powered by Claude claude-sonnet-4-6 for analysis and Gemini Flash for real-time responses.`,
    ...
    report: {
      ...
      revenueLabel: 'Projected Customer Value (lifetime)',
      paybackLabel: 'CAC Payback Period',
