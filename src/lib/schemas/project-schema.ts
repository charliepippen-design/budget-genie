...
export const MediaPlanStateSchema = z.object({
  ...
  onboardingVertical: z.string().nullable().optional(),
  onboardingSubvertical: z.string().nullable().optional(),
});

// Multi Month Store Schemas
export const MonthDataSchema = z
  .object({
    id: z.string(),
    label: z.string(),
    monthIndex: z.number(),
...
export const MultiMonthStateSchema = z
  .object({
